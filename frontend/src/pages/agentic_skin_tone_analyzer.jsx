...
const AgenticSkinToneAnalysis = () => {
  ...
  //           // Start report loader if report is requested
  //           if (getReport) setReportLoading(true);
  //           // Start outfit loader if outfit is requested
  ...
  //           // Hide report loader after a small delay for visibility
  //           setTimeout(() => setReportLoading(false), 300);

  //         } else if (data.stage === "outfit_recommendations") {
  //           partialResponse = { ...partialResponse, outfit_recommendations: data.outfit_recommendations };
  //           setBackendResponse(partialResponse);

  //           // Hide outfit loader after a small delay
