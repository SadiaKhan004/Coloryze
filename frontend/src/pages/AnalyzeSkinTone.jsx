...
const AnalyzeSkinTone = () => {
    ...
    //             const palette = data.recommended_palette || {
    //                 main_colors: [],
    //                 neutrals: [],
    //                 metallics: []
    //             };

    //             // Combine all colors from the palette
    //             const allColors = [
    //                 ...(palette.main_colors || []),
    //                 ...(palette.neutrals || []),
    //                 ...(palette.metallics || [])
    //             ].map(color => color.hex).filter(hex => hex);

    //             // Extract skin tone and undertone from the report or use apiPayload
    //             const skinTone = apiPayload.skin_tone || apiPayload.skinTone || "Unknown";
    //             const undertone = apiPayload.undertone || "Unknown";

    //             // Clean the report text - remove markdown formatting if needed
    ...
    //                 skinTone: skinTone,
    //                 undertone: undertone,
    //                 summary: `Failed to fetch detailed report: ${err.message}. Using basic analysis.`,
    //             });
                
    //             // Use colors from apiPayload if available, otherwise empty array
    //             const fallbackColors = apiPayload.colors || [];
    //             setDisplayColors(
