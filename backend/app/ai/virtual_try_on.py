...
# async def generate_virtual_tryon(user_image_bytes: bytes, garment_image_bytes: bytes) -> str:
#     """
#     Takes the user image and garment image (in bytes),
#     runs Gemini to perform background isolation + virtual try-on,
#     and returns the path of the generated try-on image.
#     """
...
#     # --- STEP 1: Isolate garment from mannequin/person ---
#     garment_prompt = """
...
#     - Replace only their current outfit with the garment.
#     - Ensure realistic fitting: align neckline, shoulders, waist, sleeves, and hem.
#     - Preserve garment’s texture, color, and design.
#     - Blend lighting/shadows seamlessly for a 100% photorealistic look.
#     """
...
#     print(f"✅ Virtual try-on image saved at: {temp_file.name}")
