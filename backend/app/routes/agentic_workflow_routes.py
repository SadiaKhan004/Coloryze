...
#                     try:
#                         matches = await run_garment_match(
#                             c["hex"],
...
#                         )
#                         if matches:
#                             outfit_results.append(matches[0])
#                     except Exception as ge:
#                         logger.exception(f"Error matching garments for {c['hex']}: {ge}")
...
#                 # --- Generate virtual try-on for ONE selected outfit ---
#                 if deduped:
